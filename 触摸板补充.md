...
1. 查看 `IORegisteryExplorer` 里 `VoodooI2C` 是否正常加载
   ...
   1. 不正常2:
      ...
      1. 七代设备出现如下字样，或者 CPU 占用极高
         ...
         **解决方案：** 在你的DSDT的触摸板设备上方加上这个，在加入之前，请确认你有没有原生的这两个常量，请根据报错内容选择性食用
...
1. 尝试**输入密码登陆界面**或者**不带鼠标开机**能不能使用触摸板
...
1. 驱动放进 `Library/Extensions`，然后重建缓存
...
### 最后，祝你早日见到这个感人的界面，用上丝滑的触摸板！
   ...
   ![Success1](https://raw.githubusercontent.com/williambj1/VoodooI2C-PreRelease/master/IMG/Success1.png)
